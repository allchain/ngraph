    ...
    namespace onnx_import
    {
        namespace op
        {
            namespace set_1
            {
                ...
                ///
                NGRAPH_API NodeVector reduce_log_sum(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_log_sum_exp(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_l1(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_l2(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_max(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_mean(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_min(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_prod(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_sum(const Node& node);
                ...
                /// \return     The nGraph node equivalent of the ONNX operation.
                ///
                NGRAPH_API NodeVector reduce_sum_square(const Node& node);
